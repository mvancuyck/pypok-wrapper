...
mapfile   = "mymap.fits"
noisefile = "/home/nponthieu/Soft/Data/dust_noise.fits"
l         = readfits( "/home/nponthieu/Soft/Data/dust_l.fits")
clt       = readfits( "/home/nponthieu/Soft/Data/dust_clt.fits")
clnoise   = readfits( "/home/nponthieu/Soft/Data/dust_clnoise.fits")
...
;; index     = !undef
;; beta      = 0
;; mapfile   = "../Data/cmb_map.fits"
;; noisefile = "../Data/cmb_noise.fits"
;; l         = readfits( "../Data/cmb_l.fits")
;; clt       = readfits( "../Data/cmb_clt.fits")
;; clnoise   = readfits( "../Data/cmb_clnoise.fits")
;; delta_l_over_l = 0.1
;; log_binning = 1
